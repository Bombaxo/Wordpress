...
*/
	...
	if(ICL_LANGUAGE_CODE == 'de'){
		...
		$subhead_name  = 'Über Neu Name';

		$cir_title_1   = 'Circle 1';
		$cir_title_2   = 'Circle 2';
		$cir_title_3   = 'Circle 3';
		...
		$subhead_name  = 'About new category name';
		...
		<main id="main" class="site-main" role="main">
			<header class="entry-header">
				...
				<div class="entry-headline">
					...
					<h1 class="entry-title">New category name</h1>
