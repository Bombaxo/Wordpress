...
*
*	Template for custom taxonomy categories from jobs - Ajax list
*/
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<div id="list"><!-- AJAX LOAD MORE -->
				<section class="list" data-path="<?php echo get_template_directory_uri(); ?>/ajax-load-more" data-post-type="jobs" data-lang="<?= ICL_LANGUAGE_CODE ?>" data-category="" data-taxonomy="kind" data-tag="<?= $cat_slug ?>" data-search="" data-display-posts="4" data-scroll="true" data-max-pages="5" data-button-text="<?php _e($static_button, 'framework'); ?>" data-transition="fade">
